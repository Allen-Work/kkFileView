...
public class DownloadUtils {
    ...
    public ReturnResponse<String> downLoad(FileAttribute fileAttribute, String  fileName) {
        ...
        String start = urlAddress.substring(0,urlAddress.lastIndexOf("=")+1);
        String end = urlAddress.substring(urlAddress.lastIndexOf("=")+1);
        end = URLEncoder.DEFAULT.encode(end, StandardCharsets.UTF_8);
        urlAddress = start+end;
